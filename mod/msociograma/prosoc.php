...
//This file corresponds to the prosoc.php. 
//Shows the prosocialization data in a chart
	...
	//cofigures data-labels (names or alias)
	...
	if ($_POST['aliasselected'] !=  null ){
		...
		$_SESSION['aliasselected'] = $_POST['aliasselected'];
    }
		if (isset($_SESSION['aliasselected']))
		$aliasselected =$_SESSION['aliasselected'];
	...
	$datos2 = array(
			 ...
			 array('value'=>get_string('alias','msociograma'),'text'=>get_string('alias','msociograma')),
				   );
	$C->datos=$datos2;
