...
//Shows the agress data in a chart
	...
	$html = $html. tableCescChartjs ('agressFis',$COURSE->id, $id, $currentgroup, array(5), 1, get_string('agressFis','msociograma').' ('.$_SESSION['group'].')','red', $alias );
	$html = $html. tableCescChartjs ('agressVerb',$COURSE->id, $id, $currentgroup, array(8), 1, get_string('agressVerb','msociograma').' ('.$_SESSION['group'].')','blue',$alias );
	$html = $html. tableCescChartjs ('agressRel',$COURSE->id, $id, $currentgroup, array(3,6), .5, get_string('agressRel','msociograma').' ('.$_SESSION['group'].')','green',$alias);
